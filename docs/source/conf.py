...
try:
    ...
    sys.path.insert(0, join(ROOT, "pyfarm"))
...
htmlhelp_basename = "pyfarm_agent"
...
latex_documents = [
    ("index", "pyfarm_agent.tex", "pyfarm.agent Documentation",
     "Oliver Palmer, Guido Winkelmann", "manual"),
]
...
intersphinx_mapping = {
    ...
    "pyfarm": (
        "https://pyfarm.readthedocs.org/en/latest", None),
    "pyfarm.core": (
        "http://pyfarm.readthedocs.org/projects/pyfarm-core/en/latest/", None),
    "pyfarm.master": (
        "http://pyfarm.readthedocs.org/projects/pyfarm-master/en/latest/", None)}
